...
//
//     final popularMovieIdModel = popularMovieIdModelFromJson(jsonString);

import 'dart:convert';

PopularMovieIdModel popularMovieIdModelFromJson(String str) => PopularMovieIdModel.fromJson(json.decode(str));

String popularMovieIdModelToJson(PopularMovieIdModel data) => json.encode(data.toJson());

class PopularMovieIdModel {
    PopularMovieIdModel({
        this.adult,
        this.backdropPath,
    ...
    factory PopularMovieIdModel.fromJson(Map<String, dynamic> json) => PopularMovieIdModel(
        ...
        popularity: json["popularity"] == null ? null : json["popularity"].todynamic(),
        ...
        voteAverage: json["vote_average"] == null ? null : json["vote_average"].todynamic(),
