...
PopularMovieIdModel popularMovieIdModelFromJson(String str) =>
    PopularMovieIdModel.fromJson(json.decode(str));

String popularMovieIdModelToJson(PopularMovieIdModel data) =>
...
class PopularMovieIdModel {
  ...
  factory PopularMovieIdModel.fromJson(Map<String, dynamic> json) =>
      PopularMovieIdModel(
